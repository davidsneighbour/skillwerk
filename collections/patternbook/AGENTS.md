...
interface patterns, responsive design, usability, accessibility, visual
audits, consistency checks, and design recommendations. There is no app,
...
```bash
node skills/patternbook/resources/some-script.ts --help
```
...
Skill directories use lowercase hyphenated names such as `patternbook` or,
